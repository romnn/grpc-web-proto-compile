...
Report bugs at https://github.com/romnnn/grpc_web_proto_compile/issues.
...
The best way to send feedback is to `file an issue <https://github.com/romnnn/grpc_web_proto_compile/issues>`_ on GitHub.
...
1. Fork the `grpc_web_proto_compile repo <https://github.com/romnnn/grpc_web_proto_compile>`_ on GitHub.
...
3. The pull request should work for python 3.5+. Check the
   `build status of your pull request <https://travis-ci.com/romnnn/grpc_web_proto_compile/pull_requests>`_
...
.. _GitHub issues: https://github.com/romnnn/grpc_web_proto_compile/issues
